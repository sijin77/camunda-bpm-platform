...
public class ExternalTaskRestServiceInteractionTest extends AbstractRestServiceTest {
  ...
  @Test
  public void shouldExtendLockOnExternalTaskWithDeprecatedProperty() {
  ...
  @Test
  public void shouldFailOnExtendLockOnExternalTaskWithNegativeNewDurationAndDeprecatedProperty() {
  ...
  @Test
  public void shouldFailToExtendLockOnNonexistentExternalTaskAndDeprecatedProperty() {
    doThrow(NotFoundException.class).when(externalTaskService).extendLock(anyString(), anyString(), anyLong());
